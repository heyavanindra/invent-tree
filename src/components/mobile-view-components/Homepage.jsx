      ...
      <div className="flex flex-col  bg-violet-100   justify-center items-center h-screen">
        ...
        <div className="p-6">
          <p className="text-black font-normal text-md text-center tracking-normal leading-tight">
            ...
            into electoral success. Our comprehensive consultancy services span
            every aspect of modern campaigning — from strategic planning and
            voter outreach to app development, branding, and real-time war room
            operations. With a strong foundation in political science,
